                        ...
                        <Card  style={{width:"86%" ,
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text style = {{ textAlign: "center", fontSize : "15px", paddingTop: "3rem", fontFamily : "verdana",}}>
                                                The project was carried out by students of group 231-365: <br />
                                                - Yezgindarova Varvara Sergeevna <br /> - Chibarchikov Artyom Ilnurovich <br /> - Aminova Amira Ainurovna
                                    </Card.Text>
